...
const yearnSupply = async (token, amount, from, to, proxy, regAddr = REGISTRY_ADDR) => {
    ...
    const tx = await executeAction('YearnSupply', functionData, proxy, regAddr);
    return tx;
};
const yearnWithdraw = async (token, amount, from, to, proxy, regAddr = REGISTRY_ADDR) => {
    ...
    const tx = await executeAction('YearnWithdraw', functionData, proxy, regAddr);
    return tx;
};
/*
*
